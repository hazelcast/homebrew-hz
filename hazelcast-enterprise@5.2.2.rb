class HazelcastEnterpriseAT522 < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/release/com/hazelcast/hazelcast-enterprise-distribution/5.2.2/hazelcast-enterprise-distribution-5.2.2.tar.gz"
    sha256 "0a29227853a8ca1ad4b02de20232728cd1d100da33047308a6c1cd50c768a57c"

class HazelcastEnterpriseAT517 < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/release/com/hazelcast/hazelcast-enterprise-distribution/5.1.7/hazelcast-enterprise-distribution-5.1.7.tar.gz"
    sha256 "fab53f10f7895291a4a9506470c7878c6a205cb69ff471609ba03efb0e73b0af"

class HazelcastEnterpriseAT573Snapshot < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/snapshot/com/hazelcast/hazelcast-enterprise-distribution/5.7.3-SNAPSHOT/hazelcast-enterprise-distribution-5.7.3-SNAPSHOT.tar.gz"
    sha256 "da371ca895dad92629405b2026cd3277c95ac73273aae98a441e7c450ae61c03"
    ...
    conflicts_with "hazelcast-enterprise@5.7.2.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.7.1", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.7.0", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.6.3.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.6.2.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.6.2", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.6.1", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.5.9", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.5.11.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.5.10.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.5.10", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise@5.4.6.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.4.5.snapshot", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise@5.4.5", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise-5.7", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-enterprise-5.1", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast-enterprise-5.0", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    conflicts_with "hazelcast@5.7.0", because: "you can install only a single hazelcast or hazelcast-enterprise package"
    ...
    conflicts_with "hazelcast-5.7", because: "you can install only a single hazelcast or hazelcast-enterprise package"

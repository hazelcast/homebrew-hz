class HazelcastEnterpriseAT511 < Formula
    desc "Hazelcast is a streaming and memory-first application platform for fast, stateful, data-intensive workloads on-premises, at the edge or as a fully managed cloud service."
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    url "https://repository.hazelcast.com/release/com/hazelcast/hazelcast-enterprise-distribution/5.1.1/hazelcast-enterprise-distribution-5.1.1.tar.gz"
    sha256 "61d4eacc8109693665ef311140712035a8cbcecab302b57f33269a1f56f491e6"
